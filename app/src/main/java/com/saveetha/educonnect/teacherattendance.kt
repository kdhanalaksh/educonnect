...
class TeacherAttendanceActivity : AppCompatActivity() {
    ...
    private fun fetchStudents(teacherId: Int) {
        val url = "http://192.168.136.226/educonnect_new_backend/get_students_attendance.php?teacher_id=$teacherId"
    ...
    private fun sendAttendance(jsonObject: JSONObject) {
        val url = "http://192.168.64.226/educonnect_new_backend/teacherattendance.php"
